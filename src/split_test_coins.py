...
if __name__ == '__main__':
    ...
    #
    #BTC
    my_private_key = CBitcoinSecret('cNDGzQkvsZN5rigPB9qb2aoTjz9YMR8H18KVCb2wjXJ9i2i4ncar')
    #BCY
    #my_private_key = CBitcoinSecret.from_secret_bytes(x('96e4085df648e4b158f458bd5cf1cb74f0bed6e64e0484778314f5555645c321'))
    ...
    txid_to_spend = (
        '7a03c60575610e6d2dca5fc7494099575e71e04087facadf53bd1b40d89f84c3')
    utxo_index = 1
